...
def mainPage() {
	...
	dynamicPage(name: "mainPage") {
        ...
        section( "Schedules" ) {
            ...
            app name: "waterHeaterScheduleChild", appName: "Water Heater Schedule (Child)", namespace: "jangellx/whsChild", title: "New Schedule", multiple: true
        }
    }
}
